...
| [TWZRD Agent Intel](https://intel.twzrd.xyz) | Free MCP server for AI agent trust scoring on Solana. Verify agent wallet identity before x402 micropayments. Tools: score_agent, preflight_check (free); get_trust_receipt (x402 paid). | [MCP Endpoint](https://intel.twzrd.xyz/mcp) |
